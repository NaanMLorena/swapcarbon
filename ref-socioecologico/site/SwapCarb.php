...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="../img-projeto-socioecologico/icones/favicon.ico" type="image/x-icon">
        <style>
            .navbar-color{
                background: rgb(2,0,36);
                background: radial-gradient(circle, rgba(2,0,36,1) 0%, rgba(41,53,67,1) 100%, rgba(0,212,255,1) 100%);
...
<body>
    ...
    <!-- Navbar (sit on top) -->
    <div class="w3-top">
        <div class="w3-bar navbar-color w3-wide w3-padding w3-card">
            <a href="#home"><img src="../img-projeto-socioecologico/swapcarb-removebg-preview.png" class="img-animate" style="width:100px; height:100px;"/></a>
